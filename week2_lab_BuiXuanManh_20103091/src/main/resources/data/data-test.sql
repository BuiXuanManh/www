...
VALUES 
    (1, '2023-09-30 10:00:00', 29.99, 'new price'),
    (1, '2023-09-30 11:00:00', 28.99, 'promote price'),
    (2, '2023-09-30 12:00:00', 19.99, 'new price'),
    (2, '2023-09-30 13:00:00', 18.99, 'promote price'),
    (3, '2023-09-30 14:00:00', 39.99, 'new price'),
    (3, '2023-09-30 15:00:00', 38.99, 'promote price'),
    (4, '2023-09-30 16:00:00', 49.99, 'new price'),
    (4, '2023-09-30 17:00:00', 48.99, 'promote price'),
    (5, '2023-09-30 18:00:00', 59.99, 'new price'),
    (5, '2023-09-30 19:00:00', 58.99, 'promote price');
INSERT INTO orders (order_date, cust_id, employee_id)
VALUES ('2023-09-30 12:00:00', 1, 1),
       ('2023-09-23 10:00:00', 2, 2),
       ('2023-09-30 15:00:00', 3, 3),
       ('2023-09-25 11:00:00', 4, 4),
       ('2023-09-26 14:00:00', 5, 5),
       ('2023-09-27 11:00:00', 6, 6),
       ('2023-09-28 12:00:00', 7, 7),
       ('2023-09-30 18:00:00', 8, 8),
       ('2023-09-30 16:00:00', 9, 9),
       ('2023-10-01 10:00:00', 10, 10),
       ('2023-10-02 13:00:00', 11, 11),
       ('2023-10-03 15:00:00', 12, 12);
    
INSERT INTO product_image (product_id, path, alternative)
VALUES 
    (1, '/images/product1.jpg', 'picture product 1'),
    (1, '/images/product2.jpg', 'picture product 2'),
    (2, '/images/product3.jpg', 'picture product 3'),
    (2, '/images/product4.jpg', 'picture product 4'),
    (3, '/images/product5.jpg', 'picture product 5');
       
    INSERT INTO order_detail (order_id, product_id, note, price_id, quantity)
VALUES (1, 1, 'Note 1', '2023-09-30 10:00:00', 2),
       (1, 2, 'Note 2', '2023-09-30 12:00:00', 3),
       (2, 3, 'Note 3', '2023-09-30 11:00:00', 1),
       (3, 4, 'Note 4', '2023-09-30 13:00:00', 4),
       (3, 5, 'Note 5', '2023-09-30 14:00:00', 2),
       (4, 6, 'Note 6', '2023-09-30 15:00:00', 3),
       (4, 7, 'Note 7', '2023-09-30 14:00:00', 1),
       (5, 8, 'Note 8', '2023-09-30 16:00:00', 5),
       (5, 9, 'Note 9', '2023-09-30 17:00:00', 2),
       (6, 10, 'Note 10', '2023-09-30 19:00:00', 4),
       (6, 11, 'Note 11', '2023-09-30 18:00:00', 2),
       (7, 12, 'Note 12', '2023-09-30 17:00:00', 3),
       (7, 13, 'Note 13', '2023-09-30 18:00:00', 1);
COMMIT;
