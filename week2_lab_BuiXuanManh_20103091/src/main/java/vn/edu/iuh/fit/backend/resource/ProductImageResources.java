...
public class ProductImageResources {
    ...
    public Response findById(@PathParam("id") Long id) {
        ProductImage productImageDTO = productImageService.findById(id).get();
    ...
    public Response getAll() {
        List<ProductImage> imageDTOS = productImageService.findAll();
    ...
    @Produces("application/json")
    public Response add(ProductImage imageDTO) {
        boolean updated = productImageService.create(imageDTO);
        if (updated) {
    ...
    @Consumes("application/json")
    @Produces("application/json")
    public Response update(@PathParam("id")Long id,ProductImage imageDTO) {
